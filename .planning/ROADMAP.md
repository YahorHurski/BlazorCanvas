...
- [x] 10-02-PLAN.md — Anchor-only persistence: MoveAsync writes only x,y; drag translates the anchor;
      the move clamp is deleted (STOR-02, STOR-04, STOR-05) [wave 2]

**Wave 3** *(blocked on Wave 2)*

- [x] 10-03-PLAN.md — D-53 anchor+geometry broadcast payload + a unit-testable SyncReceiver
...
- [x] 10-05-PLAN.md — Test-suite rework to the anchor+geometry model; the D-41 landmine asserted
      through to stored JSON (TEST-02, STOR-02, STOR-03) [wave 5]

**Wave 6** *(blocked on Wave 5)*

- [x] 10-06-PLAN.md — Clean build, full green suite, and live two-tab verification (STOR-04, STOR-05,
